...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        profiles = orm.RegistrationProfile.objects.filter(activation_key='ALREADY_ACTIVATED')
        profiles.update(activated=True)


    def backwards(self, orm):
        "Write your backwards methods here."
        profiles = orm.RegistrationProfile.objects.filter(activated=True)
        profiles.update(activation_key='ALREADY_ACTIVATED')
